			...
			<div className="max-w-5xl mx-auto px-4 py-12">
				...
				<div className="mt-12">
					<p className="text-center text-xs">
						favicon by Arto Moro from{' '}
						<a
							href="https://thenounproject.com/browse/icons/term/code/"
							target="_blank"
							title="code Icons"
							className="text-accent-primary-400 hover:text-accent-primary-300 transition-colors duration-300"
						>
							Noun Project
						</a>{' '}
						(CC BY 3.0)
